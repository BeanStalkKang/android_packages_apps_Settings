    ...
    private void updateStyleValues() {
        ...
        if (intColor == -2) {
            intColor = mSystemUiResources.getColor(
                    mSystemUiResources.getIdentifier("spie_overlay_color", "color", "com.android.systemui"));
        ...
        if (intColor == -2) {
            intColor = mSystemUiResources.getColor(
                    mSystemUiResources.getIdentifier("spie_snap_color", "color", "com.android.systemui"));
        ...
        if (intColor == -2) {
            intColor = mSystemUiResources.getColor(
                    mSystemUiResources.getIdentifier("spie_text_color", "color", "com.android.systemui"));
